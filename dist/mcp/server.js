...
export async function createMcpServer() {
    ...
    server.resource("templates", new ResourceTemplate("templates://{templateName}", { list: async () => {
            try {
    ...
    server.resource("docs", new ResourceTemplate("docs://{filePath*}", { list: async () => {
            try {
        ...
        try {
            const docsDir = path.resolve('./docs');
            const docPath = path.join(docsDir, filePath);
    ...
    server.prompt("generate-doc", "Generate documentation based on PRD content", () => {
        return {
            messages: [{
                    role: "user",
                    content: {
    ...
    server.prompt("generate-doc-with-args", {
