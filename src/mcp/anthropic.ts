...
// Define proper types for Anthropic API
 ...
 */
export async function callAnthropicApi(prompt: string, options: AnthropicOptions): Promise<string> {
  ...
  try {
    ...
    const response = await axios.post<AnthropicResponseData>(
